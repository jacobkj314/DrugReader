#this code was used to train the spaCy NER that my system uses when it is not given gold entities. 
#it is modified from the code that I wrote with Lindsay Wilde last semester in CS 5340 for an NER task
