...
#added this part to the phase2 evaluation script to make the results compatible with those of phase3
class MentionPair:
...
def evaluate(theClassifier, theTrainingData, theTestingData):
