...
Additionally, I have included some other scripts that made my development easier/possible:
    ...
    extractNegativeVectors.py : the same as above, except for with negative training examples
    trainXXXXX.py : the script to train the XXXXX-layout model. See README.pdf for details. This depends on having previously extracted vectors